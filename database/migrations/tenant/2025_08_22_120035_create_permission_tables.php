...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        // Clear permission cache only if cache table exists
        ...
        // Tambahkan data default role dan permission
    ...
    private function seedRolesAndPermissions(): void
    {
        ...
        // Loop through all permission groups (except admin_default_permissions and super_admin_permissions)
            ...
            if (is_array($permissions)) {
                foreach ($permissions as $key => $permission) {
                    if (is_array($permission)) {
                        // If permission is an array (like in a group)
                        foreach ($permission as $subPermission) {
                            $allPermissions[] = $subPermission;
                        }
                    } else {
                        // If permission is a direct string
        ...
        // Get admin permissions from config
